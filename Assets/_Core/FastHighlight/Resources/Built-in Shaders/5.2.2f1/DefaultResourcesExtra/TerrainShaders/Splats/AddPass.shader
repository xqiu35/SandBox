Shader "Merlin/5.2.2f1/Hidden/TerrainEngine/Splatmap/Diffuse-AddPass" {
	...
	Category {
		...
		SubShader {Stencil{Ref [_StencilRefValue] Comp always Pass replace ZFail replace } // for sm3.0+ targets
			CGPROGRAM
				#pragma target 3.0
				#pragma multi_compile __ _TERRAIN_NORMAL_MAP
			ENDCG
		}
		SubShader {Stencil{Ref [_StencilRefValue] Comp always Pass replace ZFail replace } // for sm2.0 targets
			CGPROGRAM
			ENDCG
		}
	}
